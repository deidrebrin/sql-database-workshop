...
> > 
> > Multiple tables:
> > * Portable, easy to share, relevant information readily visible
...
> > 
> > 1. Rename autogenerated table - burials
> > 2. Add tables: finds, hats, individuals
> > 3. Add fields
> >    * burials - type, burial ID
> >    * finds - type, burial ID, find ID
> >    * hats - colors, find ID
> >    * individuals - status, find ID
> > 4. Add relationships
> >    * burial ID - burial ID
> >    * find IDs - find IDs
> {: .solution}
...
Manage -> Database in the main menu allows you to create and edit tables, fields, and relationships among them.

The user will interact with **layouts** to view records and to add, edit, and delete entries.
